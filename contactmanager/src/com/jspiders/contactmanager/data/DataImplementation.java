...
public class DataImplementation implements Data {
	...
	public boolean exist(Contact contact) {
		...
		for(int i=0;i<index;i++) {
			if(contacts[i].getId() == contact.getId() || contacts[i].getEmail().equals(contact.getEmail()) ||
					contacts[i].getMobile() == contact.getMobile() || contacts[i].getWork() == contact.getWork()) {
